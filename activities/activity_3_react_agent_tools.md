...
Open `demos/tools.py` and examine the three existing tools:
...
Now you'll add a new tool to expand the agent's capabilities. You'll need to study the existing tools in `demos/tools.py` to understand the pattern, then implement your own.
...
In `demos/react_agent_chatbot.py`, find the tool imports section:
...
- ReAct demo code: `demos/react_agent_chatbot.py`
- Existing tools: `demos/tools.py`